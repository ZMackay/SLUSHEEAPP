...
return [
    ...
    "apiMessage"=> [
        ...
        "pin"=>[
            ...
            "removed"=>"Unpinned successfully",
            "alreadyPinned"=>"Already pinned",
        ],
        "collaborate"=>[
            "collaboratorAlredyExist"=>"collaborator already exist or pending approval",
            "requestSent"=>"collaborate request sent successfully",
            "invitationAccepted"=> "Invitation accepted successfully",
            "invitationRejected"=> "Invitation rejected successfully",
            "invitationCancelled"=> "Collaborate cancelled successfully",
    ...
    "pushNotificationMessage"=> [
        ...
        "collaborateInvitationAcepted"=>[
            ...
            "body" =>"{{USER}} accepted your invitation to Collaborate on {{REFERENCE_NAME}}.",
            "type" =>"41"
        ],
        "collaborateInvitationRejected"=>[
            "title" =>"Collaboration Invitation Rejected",
            "body" =>"{{USER}} rejected your invitation to Collaborate on {{REFERENCE_NAME}}.",
            "type" =>"42"
        ],
