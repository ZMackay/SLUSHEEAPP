...
use backend\models\PickleballCourtSearch;
use yii\web\UploadedFile;

/**
 * 
 */
class PickleballCourtController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new PickleballCourtSearch();
    ...
    public function actionDelete($id)
    {
        ...
        $userModel->status =  PickleballCourt::STATUS_DELETED;
        if($userModel->save(false)){

            Yii::$app->session->setFlash('success', "Court deleted successfully");
