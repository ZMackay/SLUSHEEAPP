        ...
        <?= dmstr\widgets\Menu::widget(
            [
                ...
                //    ['label' => 'Agents', 'icon' => 'users',  'aria-hidden'=>"true", 'url' => ['/user/agent']],
                    ...
                    [
                        'label' => 'Pop Tennis',
                        'icon' => 'fa-solid  fa-circle-thin',
                        'url' => '#',
                        'items' => [
                            ['label' => 'Courts', 'icon' => 'fa-solid  fa-circle-thin',  'aria-hidden'=>"true", 'url' => ['/pickleball-court']],
                            ['label' => 'Matches', 'icon' => 'fa-solid  fa-circle-thin',  'aria-hidden'=>"true", 'url' => ['/pickleball-match']]
